...
/** Package-private easing and cubic-Bezier evaluator. */
final class DefaultAnimationCurveEvaluation implements AnimationCurveEvaluation {
    ...
    private DefaultAnimationCurveEvaluation(String name,
                                            boolean cubicBezier,
                                            double x1,
                                            double y1,
                                            double x2,
    ...
    static AnimationCurveEvaluation named(String name) {
        return new DefaultAnimationCurveEvaluation(name, false, 0.0, 0.0, 1.0, 1.0);
    }

    static AnimationCurveEvaluation cubicBezier(double x1, double y1, double x2, double y2) {
        return new DefaultAnimationCurveEvaluation("cubicBezier", true, x1, y1, x2, y2);
    }
